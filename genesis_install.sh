...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='genesisx.conf'
CONFIGFOLDER='/root/.genesisx'
COIN_DAEMON='genesisxd'
COIN_CLI='genesisx-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/genesis-x/genesis-x/files/2065708/genesisx-1.2.1-x86_64-linux.tar.gz'
